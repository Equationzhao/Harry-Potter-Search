...
auto gotoRecord(const int &n) -> void {
    ...
    if (tempLine == 0) {
        cout << textLine[0] << endl
             << textLine[2] << endl
             << textLine[4] << endl;
    } else if (tempLine == textLine.size() - 1) {
        cout << textLine[tempLine - 4] << endl
             << textLine[tempLine - 2] << endl
             << textLine[tempLine] << endl;
    } else {
        cout << textLine[tempLine - 2] << endl
             << textLine[tempLine] << endl
             << textLine[tempLine + 2] << endl;
    }
}
...
auto showMenu() -> void {
    ...
    while (true) {
        char option[100];
        cin >> option;
        cin.ignore();//For cin.getline() will receive '\n'
